...
This plugin allows you to add a DashAssist AI agent webchat widget on every page of your WordPress website.
...
= Do I need an account at DashAssist to use this plugin? =

Yes. You need to create a website inbox and share the credentials for the plugin to work.

= Can I use the AI agent webchat in different languages? =
